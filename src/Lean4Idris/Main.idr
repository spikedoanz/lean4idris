    ...
    then do
      ...
      case result of
        Left FuelExhausted => do
          ...
          -- Add declaration to env even on timeout to prevent cascading "unknown constant" errors
          let env' = addDecl d env
          if cont
        ...
        Left err => do
          ...
          -- Add declaration to env even on failure to prevent cascading "unknown constant" errors
          let env' = addDecl d env
          if cont
